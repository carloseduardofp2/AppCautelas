...
export const styles = StyleSheet.create({
    ...
    selectionBarButtonMove: {
        backgroundColor: '#334155',
        borderWidth: 1,
        borderColor: '#475569',
    },
    selectionBarButtonCautela: {
        backgroundColor: '#D4A25F',
    },
    ...
    btnAssinarDepois: { paddingVertical: 15, paddingHorizontal: 10, borderRadius: 4, backgroundColor: '#D4A25F', borderWidth: 1, borderColor: '#e79326' },
    ...
    materialSummaryAvailable: {
        color: '#4ADE80',
        fontSize: 22,
        fontWeight: 'bold',
        marginTop: 2,
    },
    materialSummaryReserved: {
        color: '#D4A25F',
        fontSize: 22,
        fontWeight: 'bold',
        marginTop: 2,
